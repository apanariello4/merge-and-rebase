    ...
    try:
        ...
        for idx, (source_batch, target_batch) in enumerate(iterator):
            ...
            for key in common_inputs:
                ...
                reg_key = f"{key}.in"
                store = registry.setdefault(reg_key, _t.ActivationStore())
...
class BiCoRebase:
    ...
    def prepare(
        ...
        **kwargs,
        ...
        precompute_diag = _t._PrecomputeDiagnostics(assigned_keys=0, shared_transform_count=0, shared_group_count=0)
